...
def write(voxel_model, fp):
    ...
    # fp.write('data\n')
    fp.write(b'#binvox 1\n')
    fp.write(f'dim {voxel_model.dims[0]} {voxel_model.dims[1]} {voxel_model.dims[2]}\n'.encode('utf-8'))
    fp.write(f'translate {voxel_model.translate[0]} {voxel_model.translate[1]} {voxel_model.translate[2]}\n'.encode('utf-8'))
    fp.write(f'scale {voxel_model.scale}\n'.encode('utf-8'))
    fp.write(b'data\n')

    # Continue with the rest of the binary writing process
    # Note: Ensure that any other strings written to `fp` are also encoded
    ...
