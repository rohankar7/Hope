# Text Embeddings
text_captioning_model = 'gpt-4o-mini'
text_embedding_model = 'text-embedding-3-small'
descriptions_dir = './text/datasets/descriptions.csv'
captions_dir = './text/datasets/captions_hey.csv'
fused_captions_dir = './text/datasets/captions_50.csv'
embeddings_dir = './text/datasets/embeddings_50.csv'
sample_size = 1
random_seed = 36
triplane_resolution = 256
triplane_features = 4
triplane_planes = 3
triplane_dir = f'./data/triplanes/triplane_images_{triplane_resolution}_alpha'
pwd = 'C:/ShapeNetCore'
...
voxel_resolution = 64
voxel_dir = f'./data/voxels/voxel_data_{voxel_resolution}'
voxel_type = 'grayscale' # 'grayscale' / 'color'
captions = './text/ShapeNetCore_Captions.csv'

vae_weights_dir = './weights/vae_weights'
latent_dir = f'./latent_images_{triplane_resolution}'
vae_resolution = 32
vae_lr = 3e-4
vae_epochs = 3000
vae_warmup_epochs = 10
mlp_weights_dir = './weights/mlp_weights'
