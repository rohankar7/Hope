...
descriptions_dir = './text/descriptions.csv'
captions_dir = './text/captions.csv'
# fused_captions_dir = './text/fused_captions.csv'
fused_captions_dir = './text/captions_50.csv'
embeddings_dir = './text/embeddings_50.csv'
sample_size = 1
random_seed = 36
